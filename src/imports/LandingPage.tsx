...
function Frame() {
  return (
    <div className="col-1 ml-[116.33px] mt-0 relative row-1 size-[23.998px]" data-name="Frame">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 23.9978 23.9978">
        <g clipPath="url(#clip0_1_574)" id="Frame">
          <g id="Vector">
            <path d={svgPaths.p37ed3c00} fill="var(--fill-0, white)" />
            <path d={svgPaths.p37ed3c00} fill="url(#paint0_linear_1_574)" />
          </g>
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_574" x1="0.000257664" x2="17.5147" y1="23.9978" y2="30.2272">
            <stop stopColor="#AA45E8" />
            <stop offset="1" stopColor="#E84592" />
          </linearGradient>
          <clipPath id="clip0_1_574">
            <rect fill="white" height="23.9978" width="23.9978" />
          </clipPath>
        </defs>
      </svg>
    </div>
...
function NavItem() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Nav Item">
      <Frame />
      <p className="col-1 font-['Plus_Jakarta_Sans:Light',sans-serif] font-light leading-[1.2] ml-[21.02px] mt-0 relative row-1 text-[21.017px] text-white">CHANGE</p>
      <p className="col-1 font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.2] ml-0 mt-0 relative row-1 text-[21.017px] text-white">AI</p>
      <p className="col-1 font-['Plus_Jakarta_Sans:Light',sans-serif] font-light leading-[1.2] ml-[143.58px] mt-0 relative row-1 text-[21.017px] text-white">MANAGEMENT</p>
    </div>
  );
}
...
function ButtonContainer() {
  return (
    <div className="bg-white content-stretch flex h-[43.1px] items-center justify-center px-[11.195px] py-[8.956px] relative rounded-[22.389px] shrink-0 w-[181.355px]" data-name="Button Container">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[16.792px] relative shrink-0 text-[#0d1353] text-[13.434px] text-center uppercase">Watch the vıdeo</p>
    </div>
  );
}
...
function ButtonContainer1() {
  return (
    <div className="content-stretch flex h-[53.154px] items-center justify-center px-[43px] py-[11.045px] relative rounded-[27.612px] shrink-0" data-name="Button Container" style={{ backgroundImage: "linear-gradient(161.704deg, rgb(170, 69, 232) 26.236%, rgb(36, 69, 255) 86.882%), linear-gradient(90deg, rgb(255, 0, 246) 0%, rgb(255, 0, 246) 100%)" }}>
...
function ContentContainer() {
  return (
    <div className="content-stretch flex gap-[36.586px] items-center justify-center relative shrink-0 w-full" data-name="Content Container">
      <div className="flex-[1_0_0] h-[323.848px] min-h-px min-w-px relative rounded-[8.788px]" data-name="Image">
        <video autoPlay className="absolute max-w-none object-cover rounded-[8.788px] size-full" controlsList="nodownload" loop playsInline>
          <source src="/_videos/v1/deb02e2f0392a2e2a1cd28e8bc82252e113852b2" />
        </video>
      </div>
      <TextContainer />
    </div>
...
function ContentSection() {
  return (
    <div className="content-stretch flex flex-col gap-[46px] items-center relative shrink-0 w-full" data-name="Content Section">
      <HeadlineContainer />
      <ContentContainer />
    </div>
  );
...
function Hero() {
  return (
    <div className="h-[749px] relative shrink-0 w-full" data-name="hero">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgHero} />
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col gap-[56px] items-center justify-center pb-[55.225px] px-[180px] relative size-full">
          <NavBar />
          <ContentSection />
        </div>
      </div>
...
function RecognitionItems() {
  return (
    <div className="content-center flex flex-wrap gap-[40px_11px] items-center justify-center relative shrink-0 w-full" data-name="Recognition Items">
      <div className="h-[168.803px] relative shrink-0 w-[176.598px]" data-name="Recognition Item-1 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgRecognitionItem11} />
      </div>
      <div className="h-[168.803px] relative shrink-0 w-[176.598px]" data-name="Recognition Item-2 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgRecognitionItem21} />
      </div>
      <div className="h-[168.803px] relative shrink-0 w-[176.598px]" data-name="Recognition Item-3 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgRecognitionItem31} />
      </div>
      <div className="h-[168.803px] relative shrink-0 w-[176.598px]" data-name="Recognition Item-4 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgRecognitionItem41} />
      </div>
      <div className="h-[168.803px] relative shrink-0 w-[176.598px]" data-name="Recognition Item 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgRecognitionItem1} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Recognition Section">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[35.206px] items-center px-[270px] py-[39.348px] relative w-full">
          <HeadlineContainer1 />
          <RecognitionItems />
        </div>
      </div>
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[14px] items-start relative shrink-0 w-full">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[38.657px] tracking-[-1.5463px] w-full">
        <span className="leading-[normal]">The</span>
        <span className="font-['Playfair_Display:Bold_Italic',sans-serif] italic leading-[normal]">{` $50 Billion Problem `}</span>
        <span className="leading-[normal]">{`Nobody's Talking About`}</span>
      </p>
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[22.09px] relative shrink-0 text-[17.948px] tracking-[-0.1795px] w-full">Right now, Fortune 500 companies and mid-market enterprises are hemorrhaging money on AI initiatives that look brilliant on paper but die silent deaths in execution.</p>
      <div className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[22.78px] relative shrink-0 text-[16.567px] tracking-[-0.1657px] w-full">
        <p className="mb-[8.28372859954834px]">The technology works. The strategy is sound. The ROI projections are real.</p>
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[27px] items-start min-h-px min-w-px relative text-[#0d1353] whitespace-pre-wrap">
      <Frame1 />
      <div className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[17.258px] relative shrink-0 text-[17.948px] tracking-[-0.1795px] w-full">
        <p className="mb-[8.28372859954834px]">{`This isn't a technology problem.`}</p>
        <p className="mb-[8.28372859954834px]">{`It's a people problem.`}</p>
...
function StatTextContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[6.213px] items-start relative shrink-0 w-[200px]" data-name="Stat Text Container">
      <p className="bg-clip-text font-['Plus_Jakarta_Sans:Light',sans-serif] font-light leading-[normal] relative shrink-0 text-[49.702px] tracking-[-1.9881px]" style={{ backgroundImage: "linear-gradient(120.419deg, rgb(170, 69, 232) 26.236%, rgb(36, 69, 255) 86.882%)", WebkitTextFillColor: "transparent" }}>
        95%
      </p>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[23.471px] min-w-full relative shrink-0 text-[#0d1353] text-[16.567px] tracking-[-0.6627px] w-[min-content] whitespace-pre-wrap">of generative AI pilots fail to deliver measurable business impact</p>
    </div>
  );
}
...
function StatTextContainer1() {
  return (
    <div className="content-stretch flex flex-col gap-[9.664px] items-start relative shrink-0 w-[200px]" data-name="Stat Text Container">
      <p className="bg-clip-text font-['Plus_Jakarta_Sans:Light',sans-serif] font-light leading-[normal] relative shrink-0 text-[49.702px] tracking-[-1.9881px]" style={{ backgroundImage: "linear-gradient(120.659deg, rgb(170, 69, 232) 26.236%, rgb(36, 69, 255) 86.882%)", WebkitTextFillColor: "transparent" }}>
        45%
      </p>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[23.471px] min-w-full relative shrink-0 text-[#0d1353] text-[16.567px] tracking-[-0.6627px] w-[min-content] whitespace-pre-wrap">of CEOs report their employees are openly resistant or hostile to AI adoption</p>
    </div>
  );
}
...
function StatTextContainer2() {
  return (
    <div className="content-stretch flex flex-col gap-[9.664px] items-start relative shrink-0 w-[200px]" data-name="Stat Text Container">
      <p className="bg-clip-text font-['Plus_Jakarta_Sans:Light',sans-serif] font-light leading-[normal] relative shrink-0 text-[49.702px] tracking-[-1.9881px]" style={{ backgroundImage: "linear-gradient(118.706deg, rgb(170, 69, 232) 26.236%, rgb(36, 69, 255) 86.882%)", WebkitTextFillColor: "transparent" }}>
        74%
      </p>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[23.471px] min-w-full relative shrink-0 text-[#0d1353] text-[16.567px] tracking-[-0.6627px] w-[min-content] whitespace-pre-wrap">{`of organizations can't scale even after multiple successful pilots`}</p>
    </div>
  );
}
...
function StatTextContainer3() {
  return (
    <div className="content-stretch flex flex-col gap-[6.213px] items-start relative shrink-0 w-[200px]" data-name="Stat Text Container">
      <p className="bg-clip-text font-['Plus_Jakarta_Sans:Light',sans-serif] font-light leading-[normal] relative shrink-0 text-[49.702px] tracking-[-1.9881px]" style={{ backgroundImage: "linear-gradient(117.447deg, rgb(170, 69, 232) 26.236%, rgb(36, 69, 255) 86.882%)", WebkitTextFillColor: "transparent" }}>
        41%
      </p>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[23.471px] min-w-full relative shrink-0 text-[#0d1353] text-[16.567px] tracking-[-0.6627px] w-[min-content] whitespace-pre-wrap">of younger workers admit to actively undermining AI efforts they view as threatening</p>
    </div>
  );
}
...
function StatsContainer() {
  return (
    <div className="content-start flex flex-wrap gap-[22px_31.754px] items-start relative shrink-0 w-full" data-name="Stats Container">
      <StatTextContainer />
      <StatTextContainer1 />
      <StatTextContainer2 />
      <StatTextContainer3 />
...
function TextContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[17.948px] items-center justify-center min-h-px min-w-px relative" data-name="Text Container">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[22.09px] relative shrink-0 text-[#0d1353] text-[17.948px] tracking-[-0.1795px] w-full whitespace-pre-wrap">{`Here's what they're discovering:`}</p>
      <StatsContainer />
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="bg-white content-end flex flex-wrap gap-[69px] items-end px-[270px] py-[68px] relative shrink-0 w-[1489px]">
      <Frame2 />
      <TextContainer1 />
    </div>
  );
...
function TestimonialContent() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16.574px] items-start left-0 text-[#0d1353] top-0 w-[439.727px] whitespace-pre-wrap" data-name="Testimonial Content">
...
function TestimonialContainer() {
  return (
    <div className="h-[125.574px] relative shrink-0 w-[439.727px]" data-name="Testimonial Container">
      <TestimonialContent />
    </div>
  );
}
  ...
  return (
    <div className="bg-[#f5f4fc] relative shrink-0 w-full" data-name="Content Section">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-center flex flex-wrap gap-[11.735280990600586px_11.735px] items-center justify-center px-[180px] py-[17.258px] relative w-full">
...
function StatTextContainer4() {
  return (
    <div className="col-1 content-stretch flex gap-[13.116px] h-[33.922px] items-center ml-[38.54px] mt-[28.37px] relative rounded-[6.903px] row-1 w-[276.815px]" data-name="Stat Text Container">
      <Container />
      <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[1.2] min-h-px min-w-px relative text-[#0d1353] text-[16.567px] whitespace-pre-wrap">AI implementation specialists who can build the systems</p>
    </div>
  );
}
...
function StatContainer() {
  return (
    <div className="flex-[1_0_0] grid-cols-[max-content] grid-rows-[max-content] inline-grid min-h-px min-w-px place-items-start relative" data-name="Stat Container">
      <div className="backdrop-blur-[7.102px] bg-white col-1 h-[90.661px] ml-0 mt-0 rounded-[6.903px] row-1 shadow-[0px_7.102px_21.307px_0px_rgba(12,60,84,0.2)] w-[353.902px]" data-name="top body" />
      <StatTextContainer4 />
    </div>
  );
}
...
function StatTextContainer5() {
  return (
    <div className="col-1 content-stretch flex gap-[13.116px] h-[33.922px] items-center ml-[32.33px] mt-[28.07px] relative rounded-[6.903px] row-1 w-[289.24px]" data-name="Stat Text Container">
      <Container1 />
      <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[1.2] min-h-px min-w-px relative text-[#0d1353] text-[16.567px] whitespace-pre-wrap">Strategy consultants who can design the roadmap</p>
    </div>
  );
}
...
function StatTextContainer6() {
  return (
    <div className="col-1 content-stretch flex gap-[13.116px] h-[33.922px] items-center ml-[35.09px] mt-[28.07px] relative rounded-[6.903px] row-1 w-[283.718px]" data-name="Stat Text Container">
      <Container2 />
      <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[1.2] min-h-px min-w-px relative text-[#0d1353] text-[16.567px] whitespace-pre-wrap">Technology vendors who can sell them the tools</p>
    </div>
  );
}
...
function StatsContainer1() {
  return (
    <div className="content-stretch flex flex-col gap-[13.806px] h-[299.595px] items-start justify-center leading-[0] relative shrink-0 w-[354.129px]" data-name="Stats Container">
      <StatContainer />
      <StatContainer1 />
      <StatContainer2 />
    </div>
...
function TextContainer2() {
  return (
    <div className="content-stretch flex flex-col gap-[21.4px] items-start relative shrink-0 w-[354.129px]" data-name="Text Container">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[22.09px] min-w-full relative shrink-0 text-[#0d1353] text-[17.948px] tracking-[-0.1795px] w-[min-content] whitespace-pre-wrap">Every enterprise has access to:</p>
      <StatsContainer1 />
    </div>
  );
}
...
function TextContainer3() {
  return (
    <div className="content-stretch flex flex-col gap-[29.683px] items-start justify-end relative shrink-0 w-[445.941px]" data-name="Text Container">
      <TextContainer4 />
      <ButtonContainer2 />
    </div>
  );
...
function ContentContainer1() {
  return (
    <div className="content-center flex flex-wrap gap-[69.72138214111328px_69.721px] items-center justify-center relative shrink-0 w-full" data-name="Content Container">
      <TextContainer2 />
      <TextContainer3 />
    </div>
  );
...
function ContentSection2() {
  return (
    <div className="bg-white h-[762px] relative shrink-0 w-full" data-name="Content Section">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[37.967px] items-center justify-center px-[235px] py-[37.967px] relative size-full">
...
function TextContainer6() {
  return (
    <div className="content-stretch flex flex-col font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold gap-[6.213px] items-start relative shrink-0 text-center text-white w-full whitespace-pre-wrap" data-name="Text Container">
      <p className="leading-[0] relative shrink-0 text-[38.657px] tracking-[-1.5463px] w-full">
      ...
      <p className="leading-[22.09px] relative shrink-0 text-[17.948px] tracking-[-0.1795px] w-full">When employees push back on AI, leadership interprets it as:</p>
    </div>
  );
}
...
function TextContainer8() {
  return (
    <div className="content-stretch flex gap-[17.258px] items-center relative shrink-0" data-name="Text Container">
      <Container3 />
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[22.09px] relative shrink-0 text-[17.948px] text-white tracking-[-0.1795px]">Resistance to change</p>
    </div>
  );
}
...
function TextContainer9() {
  return (
    <div className="content-stretch flex gap-[17.258px] items-center relative shrink-0" data-name="Text Container">
      <Container4 />
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[22.09px] relative shrink-0 text-[17.948px] text-white tracking-[-0.1795px]">Lack of Vision</p>
    </div>
  );
}
...
function TextContainer10() {
  return (
    <div className="content-stretch flex gap-[17.258px] items-center relative shrink-0" data-name="Text Container">
      <Container5 />
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[22.09px] relative shrink-0 text-[17.948px] text-white tracking-[-0.1795px]">Generational Friction</p>
    </div>
  );
}
...
function TextContainer11() {
  return (
    <div className="content-stretch flex gap-[17.258px] items-center relative shrink-0" data-name="Text Container">
      <Container6 />
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[22.09px] relative shrink-0 text-[17.948px] text-white tracking-[-0.1795px]">Fear of job loss</p>
    </div>
  );
}
...
function TextContainer7() {
  return (
    <div className="content-start flex flex-wrap gap-[36.586463928222656px_36.586px] items-start justify-center relative shrink-0 w-full" data-name="Text Container">
      <TextContainer8 />
      <TextContainer9 />
      <TextContainer10 />
      <TextContainer11 />
...
function ContentContainer2() {
  return (
    <div className="content-stretch flex gap-[60.057px] items-center justify-center relative shrink-0 w-full" data-name="Content Container">
      <TextContainer12 />
      <div className="flex-[1_0_0] h-[324.785px] min-h-px min-w-px relative rounded-[11.045px]" data-name="digital-art-style-portrait-adult-woman 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[11.045px] size-full" src={imgDigitalArtStylePortraitAdultWoman1} />
      </div>
    </div>
  );
}
...
function ButtonContainer3() {
  return (
    <div className="bg-white content-stretch flex h-[53.154px] items-center justify-center px-[13.806px] py-[11.045px] relative rounded-[27.612px] shrink-0 w-[441.799px]" data-name="Button Container">
...
function Image() {
  return (
    <div className="content-stretch flex flex-col gap-[55.915px] items-center justify-center px-[270px] py-[80px] relative shrink-0 w-[1489px]" data-name="Image">
...
function TestimonialContent1() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[16.574px] items-start left-0 text-[#0d1353] top-0 w-[389.212px] whitespace-pre-wrap" data-name="Testimonial Content">
...
function TestimonialContainer1() {
  return (
    <div className="h-[127.574px] relative shrink-0 w-[389.212px]" data-name="Testimonial Container">
      <TestimonialContent1 />
    </div>
  );
}
...
function ContentSection3() {
  return (
    <div className="bg-[#f5f5fc] relative shrink-0 w-full" data-name="Content Section">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-center flex flex-wrap gap-[11.761886596679688px_11.762px] items-center justify-center px-[180px] py-[17.258px] relative w-full">
...
function Container9() {
  return (
    <div className="content-stretch flex flex-col gap-[11.735px] items-center relative shrink-0 w-full" data-name="Container">
      ...
      <div className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[90.59500122070312%] relative shrink-0 text-[#0d1353] text-[38.657px] tracking-[-1.5463px] w-[844.25px]">
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col gap-[10.355px] items-center relative shrink-0 text-center w-full whitespace-pre-wrap" data-name="Container">
      <Container9 />
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[22.78px] relative shrink-0 text-[#0d1353] text-[16.567px] tracking-[0.1657px] w-[855.295px]">{`This isn't a theory. This isn't AI hype. This is the strategic positioning, language, and frameworks you need to position yourself as the AI adoption specialist that enterprises are actively seeking right now.`}</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[11.045px] items-start min-h-px min-w-px py-[33px] relative text-[#0d1353] whitespace-pre-wrap" data-name="Container">
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[25px] relative shrink-0 text-[22.09px] tracking-[-0.4418px] w-full">The Enterprise AI Adoption Framework</p>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[23.471px] relative shrink-0 text-[16.567px] tracking-[-0.1657px] w-full">{`Why AI initiatives fail at the cultural level (not the technical level) and how to diagnose resistance before it kills adoption. You'll understand the problem better than the CTOs who hired you.`}</p>
    </div>
  );
}
...
function ContentContainer3() {
  return (
    <div className="bg-[#f5f5fc] relative rounded-[14px] shrink-0 w-full" data-name="Content Container">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-center flex flex-wrap gap-[67px] items-center justify-center pl-[40px] relative w-full">
          <Container11 />
          <div className="flex-[1_0_0] h-[245.045px] min-h-px min-w-px relative rounded-br-[14px] rounded-tr-[14px]" data-name="Germany 2">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-br-[14px] rounded-tr-[14px] size-full" src={imgGermany2} />
          </div>
        </div>
      </div>
    </div>
...
function Container12() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[11.045px] items-start min-h-px min-w-px py-[33px] relative text-[#0d1353] whitespace-pre-wrap" data-name="Container">
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[25px] relative shrink-0 text-[22.09px] tracking-[-0.4418px] w-full">The Psychology of AI Resistance</p>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[23.471px] relative shrink-0 text-[16.567px] tracking-[-0.1657px] w-full">{`The real fears driving pushback (it's not what leadership thinks), how to surface them without creating defensiveness, and the reframing techniques that turn resistors into champions.`}</p>
    </div>
  );
}
  ...
  return (
    <div className="bg-[#f5f5fc] relative rounded-[14px] shrink-0 w-full" data-name="Content Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-center flex flex-wrap gap-[67px] items-center pr-[40px] relative w-full">
          <div className="flex-[1_0_0] h-[245.045px] min-h-px min-w-px relative rounded-bl-[14px] rounded-tl-[14px]" data-name="Germany 2">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-bl-[14px] rounded-tl-[14px]">
              <img alt="" className="absolute max-w-none object-cover rounded-bl-[14px] rounded-tl-[14px] size-full" src={imgGermany2} />
              <img alt="" className="absolute max-w-none object-cover rounded-bl-[14px] rounded-tl-[14px] size-full" src={imgGermany3} />
            </div>
          </div>
          <Container12 />
        </div>
...
function Container13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[11.045px] items-start min-h-px min-w-px py-[33px] relative text-[#0d1353] whitespace-pre-wrap" data-name="Container">
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[25px] relative shrink-0 text-[22.09px] tracking-[-0.4418px] w-full">The Human-Centered AI Implementation Model</p>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[23.471px] relative shrink-0 text-[16.567px] tracking-[-0.1657px] w-full">How to design AI systems that preserve human judgment, expertise, and value so adoption feels like elevation, not replacement. This is what separates $5K consultants from $50K consultants.</p>
    </div>
  );
}
...
function ContentContainer5() {
  return (
    <div className="bg-[#f5f5fc] relative rounded-[14px] shrink-0 w-full" data-name="Content Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-center flex flex-wrap gap-[67px] items-center pl-[40px] relative w-full">
          <Container13 />
          <div className="flex-[1_0_0] h-[245.045px] min-h-px min-w-px relative rounded-br-[14px] rounded-tr-[14px]" data-name="Germany 2">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-br-[14px] rounded-tr-[14px]">
              <img alt="" className="absolute max-w-none object-cover rounded-br-[14px] rounded-tr-[14px] size-full" src={imgGermany2} />
              <div className="absolute inset-0 overflow-hidden rounded-br-[14px] rounded-tr-[14px]">
                <img alt="" className="absolute h-[171.81%] left-0 max-w-none top-[-13.13%] w-full" src={imgGermany4} />
              </div>
            </div>
          </div>
        </div>
...
function Container14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[11.045px] items-start min-h-px min-w-px py-[33px] relative text-[#0d1353] whitespace-pre-wrap" data-name="Container">
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[25px] relative shrink-0 text-[22.09px] tracking-[-0.4418px] w-full">How to Position Yourself for Premium Consulting Fees</p>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[23.471px] relative shrink-0 text-[16.567px] tracking-[-0.1657px] w-full">{`The language, credentials, and strategic positioning that gets you in the room with decision-makers and justifies rates that reflect the value you're creating (not the hours you're billing).`}</p>
    </div>
  );
}
        ...
        <div className="content-center flex flex-wrap gap-[67px] items-center pr-[40px] relative w-full">
          <div className="flex-[1_0_0] h-[245.045px] min-h-px min-w-px relative rounded-bl-[14px] rounded-tl-[14px]" data-name="Germany 2">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-bl-[14px] rounded-tl-[14px]">
              <img alt="" className="absolute max-w-none object-cover rounded-bl-[14px] rounded-tl-[14px] size-full" src={imgGermany2} />
              <img alt="" className="absolute max-w-none object-cover rounded-bl-[14px] rounded-tl-[14px] size-full" src={imgGermany3} />
              <img alt="" className="absolute max-w-none object-cover rounded-bl-[14px] rounded-tl-[14px] size-full" src={imgGermany5} />
            </div>
          </div>
          <Container14 />
        </div>
...
function Container15() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[11.045px] items-start min-h-px min-w-px py-[33px] relative text-[#0d1353] whitespace-pre-wrap" data-name="Container">
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[25px] relative shrink-0 text-[22.09px] tracking-[-0.4418px] w-full">Your Path to Certification (If You Want It)</p>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[23.471px] relative shrink-0 text-[16.567px] tracking-[-0.1657px] w-full">An introduction to the Industry Rockstar AI Change Management Certification Program: the credentials, frameworks, and ongoing support that lets you serve enterprise clients with confidence and authority.</p>
    </div>
  );
}
        ...
        <div className="content-center flex flex-wrap gap-[67px] items-center pl-[40px] relative w-full">
          ...
          <div className="flex-[1_0_0] h-[245.045px] min-h-px min-w-px relative rounded-br-[14px] rounded-tr-[14px]" data-name="Germany 2">
            <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-br-[14px] rounded-tr-[14px]">
              <img alt="" className="absolute max-w-none object-cover rounded-br-[14px] rounded-tr-[14px] size-full" src={imgGermany2} />
              <div className="absolute inset-0 overflow-hidden rounded-br-[14px] rounded-tr-[14px]">
                <img alt="" className="absolute h-[153.39%] left-0 max-w-none top-[-3.08%] w-full" src={imgGermany4} />
              </div>
              <img alt="" className="absolute max-w-none object-cover rounded-br-[14px] rounded-tr-[14px] size-full" src={imgGermany6} />
            </div>
          </div>
        </div>
      </div>
...
function ContentSection4() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Content Section">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[46.251px] items-center px-[270px] py-[75.934px] relative w-full">
          <Container7 />
          <Container10 />
        </div>
      </div>
...
function Container17() {
  return (
    <div className="content-stretch flex flex-col gap-[4.832px] items-center relative shrink-0 w-full" data-name="Container">
      ...
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#0d1353] text-[0px] tracking-[-1.5463px] w-[844.25px]">
...
function Container16() {
  return (
    <div className="content-stretch flex flex-col gap-[10.355px] items-center relative shrink-0 text-center w-[642.679px] whitespace-pre-wrap" data-name="Container">
      <Container17 />
...
function TextContainer16() {
  return (
    <div className="content-stretch flex gap-[37.277px] items-center justify-center relative shrink-0 w-full" data-name="Text Container">
      <Container27 />
      <Container32 />
    </div>
  );
...
function ContentSection5() {
  return (
    <div className="bg-[#f5f5fc] relative shrink-0 w-full" data-name="Content Section">
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col gap-[44.18px] items-center px-[270px] py-[69px] relative w-full">
          <Container16 />
          <TextContainer15 />
        </div>
      </div>
...
function LeadershipTitle() {
  return (
    <div className="content-stretch flex flex-col gap-[4.832px] items-start relative shrink-0 text-center w-full whitespace-pre-wrap" data-name="Leadership Title">
...
function TextContainer19() {
  return (
    <div className="content-stretch flex gap-[28.993px] items-end justify-center relative shrink-0 w-full" data-name="Text Container">
      <div className="h-[237.233px] relative shrink-0 w-[460.898px]" data-name="kane 12">
...
function TextContainer21() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[31.754px] items-end justify-center min-h-px min-w-px relative w-full" data-name="Text Container">
      <TextContainer22 />
      <div className="h-[224.203px] relative shrink-0 w-[460.9px]" data-name="Group 1171275808 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgGroup11712758081} />
      </div>
    </div>
  );
}
...
function TextContainer18() {
  return (
    <div className="content-stretch flex flex-col gap-[21.4px] h-[482.836px] items-center justify-center relative shrink-0 w-full" data-name="Text Container">
      <TextContainer19 />
      <TextContainer21 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Stats Container">
      <div className="flex flex-row justify-center size-full">
        <div className="content-start flex flex-wrap gap-[30.37367057800293px_30.374px] items-start justify-center px-[75px] relative w-full">
          <StatTextContainer7 />
          <StatTextContainer8 />
          <StatTextContainer9 />
          <StatTextContainer10 />
...
function ButtonContainer4() {
  return (
    <div className="content-stretch flex h-[53.154px] items-center justify-center px-[13.806px] py-[11.045px] relative rounded-[27.612px] shrink-0 w-[472.172px]" data-name="Button Container" style={{ backgroundImage: "linear-gradient(162.437deg, rgb(170, 69, 232) 26.236%, rgb(36, 69, 255) 86.882%), linear-gradient(90deg, rgb(255, 0, 246) 0%, rgb(255, 0, 246) 100%)" }}>
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[20.709px] relative shrink-0 text-[16.567px] text-center text-white uppercase">REGISTER FOR THE NEXT AVAILABLE SESSION</p>
    </div>
  );
}
...
function ContentSection6() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Content Section">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[54px] items-center justify-center px-[270px] py-[88px] relative w-full">
          <LeadershipTitle />
          <TextContainer17 />
          <TextContainer23 />
        </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[4.832px] items-center relative shrink-0 w-full" data-name="Container">
      ...
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[0] relative shrink-0 text-[#0d1353] text-[0px] tracking-[-1.5463px] w-full">
        <span className="leading-[86.27999877929688%] text-[38.657px]">{`AI Isn't Here to Replace People. It's Here to Redefine `}</span>
        <span className="font-['Playfair_Display:SemiBold_Italic',sans-serif] font-semibold italic leading-[86.27999877929688%] text-[42.799px]">How Value Is Created.</span>
      </p>
    </div>
  );
}
...
function Container37() {
  return (
    <div className="content-stretch flex flex-col gap-[26.922px] items-center relative shrink-0 text-center w-full whitespace-pre-wrap" data-name="Container">
      <Container38 />
      <TextContainer26 />
    </div>
  );
  ...
  return (
    <div className="bg-[rgba(255,255,255,0.8)] flex-[1_0_0] min-h-px min-w-px relative rounded-[18.969px]" data-name="Container">
      ...
      <div className="content-stretch flex flex-col gap-[17.258px] items-start pb-[38px] pt-[33.196px] px-[33.196px] relative w-full">
        <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[28.454px] relative shrink-0 text-[#e84592] text-[23.711px] w-full whitespace-pre-wrap">From...</p>
        <Container40 />
        <Container42 />
        <Container44 />
        <Container46 />
...
function TextContainer27() {
  return (
    <div className="relative shrink-0 w-full" data-name="Text Container">
      <div className="flex flex-row items-center size-full">
        <div className="content-center flex flex-wrap gap-[27.6124267578125px_27.612px] items-center px-[119px] relative w-full">
          <Container39 />
          <Container48 />
        </div>
      </div>
...
function TextContainer35() {
  return (
    <div className="content-stretch flex gap-[13.806px] items-start relative shrink-0 w-full" data-name="Text Container">
      <Container53 />
      <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[0] min-h-px min-w-px relative text-[15.187px] text-white whitespace-pre-wrap">
        <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.2]">{`You'll receive immediate confirmation with your Zoom link`}</span>
        <span className="leading-[1.2]">{` and calendar invite`}</span>
      </p>
    </div>
  );
}
...
function TextContainer36() {
  return (
    <div className="content-stretch flex gap-[13.806px] items-start relative shrink-0 w-full" data-name="Text Container">
      <Container54 />
      <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[0] min-h-px min-w-px relative text-[15.187px] text-white whitespace-pre-wrap">
        <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.2]">{`You'll get a pre-workshop email `}</span>
        <span className="leading-[1.2]">with context on what to expect and how to prepare</span>
      </p>
    </div>
  );
}
...
function TextContainer37() {
  return (
    <div className="content-stretch flex gap-[13.806px] items-start relative shrink-0 w-full" data-name="Text Container">
      <Container55 />
      <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[0] min-h-px min-w-px relative text-[15.187px] text-white whitespace-pre-wrap">
        <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.2]">{`You'll join us for 90-120 minutes `}</span>
        <span className="leading-[1.2]">of strategic positioning, frameworks, and real talk about the AI change management opportunity</span>
      </p>
    </div>
  );
}
...
function TextContainer38() {
  return (
    <div className="content-stretch flex gap-[13.806px] items-start relative shrink-0 w-full" data-name="Text Container">
      <Container56 />
      <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[0] min-h-px min-w-px relative text-[15.187px] text-white whitespace-pre-wrap">
        <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.2]">{`You'll walk away with clarity `}</span>
        <span className="leading-[1.2]">on whether this specialty is right for you and how to start positioning yourself immediately</span>
      </p>
    </div>
  );
}
...
function TextContainer39() {
  return (
    <div className="content-stretch flex gap-[13.806px] items-start relative shrink-0 w-full" data-name="Text Container">
      <Container57 />
      <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[0] min-h-px min-w-px relative text-[15.187px] text-white whitespace-pre-wrap">
        <span className="leading-[1.2]">{`If you're interested in certification, `}</span>
        <span className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[1.2]">{`you'll learn about the Industry Rockstar program `}</span>
        <span className="leading-[1.2]">and how it can accelerate your positioning</span>
      </p>
    </div>
  );
}
...
function TextContainer33() {
  return (
    <div className="content-stretch flex flex-col gap-[26.232px] items-start relative shrink-0 w-[404px]" data-name="Text Container">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[normal] relative shrink-0 text-[28.993px] text-white tracking-[-1.1597px] w-full whitespace-pre-wrap">{`Here's What Happens When You Register:`}</p>
      <TextContainer34 />
    </div>
  );
}
...
function TextContainer32() {
  return (
    <div className="content-start flex flex-[1_0_0] flex-wrap gap-0 items-start justify-center min-h-px min-w-px relative" data-name="Text Container">
      <TextContainer33 />
...
function Image1() {
  return (
    <div className="content-end flex flex-wrap gap-y-[6.903106689453125px] items-end justify-center overflow-clip pt-[53px] relative rounded-[11.045px] shrink-0 w-full" data-name="Image">
...
function ButtonContainer5() {
  return (
    <div className="content-stretch flex h-[53.154px] items-center justify-center px-[13.806px] py-[11.045px] relative rounded-[27.612px] shrink-0 w-[461.128px]" data-name="Button Container" style={{ backgroundImage: "linear-gradient(162.043deg, rgb(170, 69, 232) 26.236%, rgb(36, 69, 255) 86.882%), linear-gradient(90deg, rgb(255, 0, 246) 0%, rgb(255, 0, 246) 100%)" }}>
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[20.709px] relative shrink-0 text-[16.567px] text-center text-white uppercase">REGISTER FOR THE NEXT AVAILABLE SESSION</p>
    </div>
  );
}
...
function ContentSection7() {
  return (
    <div className="bg-[#f9fafb] content-stretch flex flex-col gap-[46.251px] items-center justify-center px-[270px] py-[98px] relative shrink-0 w-[1489px]" data-name="Content Section">
      <TextContainer25 />
      <Image1 />
      <TextContainer40 />
    </div>
...
function FaqItem() {
  return (
    <div className="content-stretch flex flex-col gap-[17.948px] items-start relative shrink-0 text-white w-[693.052px] whitespace-pre-wrap" data-name="FAQ Item">
...
function Faq() {
  return (
    <div className="content-stretch flex flex-col gap-[49.702px] items-center justify-center px-[270px] py-[66px] relative shrink-0 w-[1489px]" data-name="FAQ">
...
function TextContainer43() {
  return (
    <div className="content-stretch flex flex-col gap-[13.116px] items-center relative shrink-0 text-center text-white w-full whitespace-pre-wrap" data-name="Text Container">
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold h-[87.669px] leading-[0] relative shrink-0 text-[0px] text-shadow-[0px_0px_8.077px_rgba(255,255,255,0.42)] tracking-[-1.0769px] w-[617.193px]">
      ...
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[26.232px] min-w-full relative shrink-0 text-[16.567px] w-[min-content]">{`In 90-120 minutes, you'll know exactly how to position yourself as the AI adoption specialist that enterprises are desperately seeking and what it takes to command the fees that reflect the value you're creating.`}</p>
      <p className="font-['Plus_Jakarta_Sans:Bold',sans-serif] font-bold leading-[25.541px] min-w-full relative shrink-0 text-[22.09px] tracking-[-0.2209px] w-[min-content]">{`The technology wave isn't slowing down.`}</p>
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal h-[51.083px] leading-[25.541px] relative shrink-0 text-[16.567px] tracking-[-0.1657px] w-[753.129px]">
...
function Image2() {
  return (
    <div className="relative shrink-0 w-full" data-name="Image">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col gap-[33.135px] items-center justify-center px-[270px] py-[59px] relative w-full">
          <TextContainer43 />
          <ButtonContainer6 />
        </div>
      </div>
